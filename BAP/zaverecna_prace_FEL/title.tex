...
\newcommand{\TitlePage}[2]{{
	...
	{\parbox[0][\textheight][t]{\titlewidth}{
		\sffamily 
		%\vspace{1pt}
		\includegraphics[height=4.1cm]{img/ctu_logo_blue.pdf} 
		\put(10,40){\parbox{8cm}{\Large České\\[0.3em] vysoké učení\\[0.3em] technické\\[0.3em] v Praze\\[.6em]}} \\[.1em]		
		\textbf{\Large 
...
%        \textbf{\large 
%			\color{black} Supervisor: \\[0.3em]
%			\color{cvutcolor} Ing. Stanislav Vítek, Ph.D.
%		}\\[5cm]
        
%         \textbf{\large 
% 			\color{black} Supervisor specialist: \\[0.3em]
% 			\color{cvutcolor} Ing. Ladislav Sieger, CSc.
%             \\[0.3em]
% 		}\\[2em]
