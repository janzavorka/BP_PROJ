...
//Rezimy site: ETHMODE_DHCP=server ziska IP adresu z DHCP serveru; ETHMODE_STATIC=pouzije se nastavena IP adresa
//Pri modu, kdy je IP adresa prirazena DHCP serverem, je nutne aby se IP adresa nemenila a aby byla spravne nastavena na strane clientu
#define ETHMODE_STATIC //Varianty: ETHMODE_DHCP; ETHMODE_STATIC

// Nastaveni MAC adresy (mela by byt unikatni)
byte mac[] = {
  0xDE, 0xAD, 0xBE, 0xEE, 0xFE, 0x00
};
//
//Nastaveni IP adresy serveru, pokud je nastaveno 0.0.0.0 bude IP prirazena DHCP serverem
//IP adresa serveru musi byt vyplnena v kodu pro klienty
IPAddress serverAddress(10,0,0,8);
//
//Port na kterem bude probihat komunikace
