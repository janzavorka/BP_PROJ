\begin{tikzpicture}[scale=2, node distance = 2cm, auto]
  ...
  \node (disconnect) [block, right of=test2, text width=15em, xshift=6cm] {Ukonči spojení s novým klientem (\texttt{newClient.stop()}).};
  ...
  \node (end) [block,right of=test4, text width=20em, xshift=6.5cm] {
      \begin{enumerate}
